...
- Before writing anything, search the repo for similar code. Reuse or extend before you rewrite.
- If duplication is discovered, refactor to a single abstraction.

## KISS

- Simplicity beats cleverness. Prefer the smallest, clearest solution.
- Avoid premature abstraction — don't introduce a pattern unless it serves an immediate purpose.
